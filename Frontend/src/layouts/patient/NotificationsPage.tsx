        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-ink-muted">
              Appointment reminders, follow-ups, and billing updates.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-2 text-xs">
            <button
              ...
              className={tab === "unread" ? "btn btn-primary text-xs" : "btn btn-secondary text-xs"}
            >
              Unread
            </button>
            <button
              onClick={() => setTab("all")}
              className={tab === "all" ? "btn btn-primary text-xs" : "btn btn-secondary text-xs"}
            >
              All
            </button>
