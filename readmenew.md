# Agentic AI DCIS (Web + Agentic Backend)
...
![Platform](https://img.shields.io/badge/Platform-Web-2D6CDF?style=flat)
![Build](https://img.shields.io/badge/Build-Vite-646CFF?style=flat&logo=vite&logoColor=white)
![Language](https://img.shields.io/badge/Languages-TypeScript%20%7C%20Python%20%7C%20SQL-2EA44F?style=flat)
![Status](https://img.shields.io/badge/Status-Active-success?style=flat)
![License](https://img.shields.io/badge/License-MIT-1F6FEB?style=flat)

> Assumptions (repo-driven)
>
> - Frontend lives under `Frontend/` and uses Vite.
> - Backend is Node/Express in `Backend/server.js`.
> - Agents run from `Backend/dental_agents/` using a worker process.
> - DB schema is in `Backend/db/schema_query.sql`.
...
## Overview
Agentic AI DCIS unifies scheduling, cases, billing, inventory, and notifications across Admin, Doctor, and Patient roles. A Python worker consumes the `agent_events` outbox table to drive automation and optional AI tasks with traceable state changes.
...
- Doctor layouts and pages
- Patient layouts and pages
...
## Deployment
- Containerize backend + agents for production.
